...
router.get('/albums/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)([client_1.Role.ADMIN, client_1.Role.ARTIST]), artist_controller_1.getArtistAlbums);
