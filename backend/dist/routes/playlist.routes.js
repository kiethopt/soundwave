...
router.get('/system', cache_middleware_1.cacheMiddleware, playlist_controller_1.getSystemPlaylist);
router.post('/', playlist_controller_1.createPlaylist);
router.get('/', playlist_controller_1.getPlaylists);
router.get('/:id', cache_middleware_1.cacheMiddleware, playlist_controller_1.getPlaylistById);
