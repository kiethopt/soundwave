...
router.post('/follow/:id', auth_middleware_1.authenticate, user_controller_1.followUser);
router.delete('/unfollow/:id', auth_middleware_1.authenticate, user_controller_1.unfollowUser);
router.get('/followers', auth_middleware_1.authenticate, user_controller_1.getFollowers);
