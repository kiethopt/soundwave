...
export const albums: AlbumData[] = [
  ...
  // RPT MCK - "99%" album
  {
    ...
    tracks: [
      { title: '00', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867253/00_tkouxp.mp3', trackNumber: 1, duration: 33 }, // 0:33
      { title: 'Chìm Sâu', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867262/Ch%C3%ACm_S%C3%A2u_i3wowi.mp3', trackNumber: 2, duration: 156, featuredArtists: ['Trung Trần'] }, // 2:36
      { title: 'Suit & Tie', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867269/Suit_Tie_skzbdx.mp3', trackNumber: 3, duration: 238, featuredArtists: ['Hoàng Tôn'] }, // 3:58
      { title: 'Va Vào Giai Điệu Này', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867270/Va_V%C3%A0o_Giai_%C4%90i%E1%BB%87u_N%C3%A0y_utosff.mp3', trackNumber: 4, duration: 190 }, // 3:10
      { title: 'Tối Nay Ta Đi Đâu Nhờ', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867256/T%E1%BB%91i_Nay_Ta_%C4%90i_%C4%90%C3%A2u_Nh%E1%BB%9D_ebdut1.mp3', trackNumber: 5, duration: 104 }, // 1:44
      { title: 'Chỉ Một Đêm Nữa Thôi', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867263/Ch%E1%BB%89_M%E1%BB%99t_%C4%90%C3%AAm_N%E1%BB%AFa_Th%C3%B4i_nusxzj.mp3', trackNumber: 6, duration: 141, featuredArtists: ['tlinh'] }, // 2:21
      { title: 'Thôi Em Đừng Đi', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867272/Th%C3%B4i_Em_%C4%90%E1%BB%ABng_%C4%90i_ohaw0f.mp3', trackNumber: 7, duration: 173, featuredArtists: ['Trung Trần'] }, // 2:53
      { title: '5050', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867254/5050_ozzoga.mp3', trackNumber: 8, duration: 154 }, // Là bài 8, không có thông tin duration, để ước lượng
      { title: 'Cuốn Cho Anh Một Điếu Nữa Đi', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867268/Cu%E1%BB%91n_Cho_Anh_M%E1%BB%99t_%C4%90i%E1%BA%BFu_N%E1%BB%AFa_%C4%90i_rkb07p.mp3', trackNumber: 9, duration: 60 }, // 1:00
      { title: 'Show Me Love', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867267/Show_Me_Love_zyjlvf.mp3', trackNumber: 10, duration: 154 }, // 2:34
      { title: 'Tại Vì Sao', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867269/T%E1%BA%A1i_V%C3%AC_Sao_efz5to.mp3', trackNumber: 11, duration: 203 }, // 3:23
      { title: 'Thờ Er', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867257/Th%E1%BB%9D_Er_bpag2y.mp3', trackNumber: 12, duration: 98 }, // 1:38
      { title: 'Ai Mới Là Kẻ Xấu Xa', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867261/Ai_M%E1%BB%9Bi_L%C3%A0_K%E1%BA%BB_X%E1%BA%A5u_Xa_tousdd.mp3', trackNumber: 13, duration: 192 }, // 3:12
      { title: 'Anh Đã Ổn Hơn', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867259/Anh_%C4%90%C3%A3_%E1%BB%94n_H%C6%A1n_jelhzq.mp3', trackNumber: 14, duration: 194 }, // 3:14
      { title: 'Badtrip', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867260/Badtrip_wodiv2.mp3', trackNumber: 15, duration: 158 }, // 2:38
      { title: '99', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743867259/99_w6sy6e.mp3', trackNumber: 16, duration: 171 } // 2:51
    ]
  },
  ...
  // HIEUTHUHAI - "Ai Cũng Phải Bắt Đầu Từ Đâu Đó" album
  {
    ...
    tracks: [
      { title: 'Ai Cũng Phải Bắt Đầu Từ Đâu Đó', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868107/Ai_C%C5%A9ng_Ph%E1%BA%A3i_B%E1%BA%AFt_%C4%90%E1%BA%A7u_T%E1%BB%AB_%C4%90%C3%A2u_%C4%90%C3%B3_hrkbft.mp3', trackNumber: 1, duration: 138 }, // 2:18
      { title: 'Giờ Thì Ai Cười', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868125/Gi%E1%BB%9D_Th%C3%AC_Ai_C%C6%B0%E1%BB%9Di_osmint.mp3', trackNumber: 2, duration: 186 }, // 3:06
      { title: 'Không Phải Gu', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868117/Kh%C3%B4ng_Ph%E1%BA%A3i_Gu_dapmsw.mp3', trackNumber: 3, duration: 201, featuredArtists: ['Bray', 'Tage'] }, // 3:21
      { title: 'Siêu Sao', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868182/Si%C3%AAu_Sao_udmirx.mp3', trackNumber: 4, duration: 186 }, // 3:06
      { title: 'Đi Họp Lớp', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868183/%C4%90i_H%E1%BB%8Dp_L%E1%BB%9Bp_ma7izb.mp3', trackNumber: 5, duration: 168 }, // 2:48
      { title: 'Không Thể Say', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868183/Kh%C3%B4ng_Th%E1%BB%83_Say_rby9p0.mp3', trackNumber: 6, duration: 228 }, // 3:48
      { title: 'Exit Sign', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868118/Exit_Sign_s0mayg.mp3', trackNumber: 7, duration: 201, featuredArtists: ['marzuz'] }, // 3:21
      { title: 'Visa Interlude', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868179/Visa_Interlude_pzbphx.mp3', trackNumber: 8, duration: 41 }, // 0:41
      { title: 'Sắp Nổi Tiếng', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868185/S%E1%BA%AFp_N%E1%BB%95i_Ti%E1%BA%BFng_doshig.mp3', trackNumber: 9, duration: 222 }, // 3:42
      { title: 'KPI', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868189/KPI_d1ppwf.mp3', trackNumber: 10, duration: 209 }, // 3:29
      { title: 'Everything Will Be Okay', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868122/Everything_Will_Be_Okay_w2e95y.mp3', trackNumber: 11, duration: 199 }, // 3:19
      { title: 'Cho Em An Toàn', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868125/Cho_Em_An_To%C3%A0n_spfd7l.mp3', trackNumber: 12, duration: 231 }, // 3:51
      { title: 'NOLOVENOLIFE', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743868186/NOLOVENOLIFE_ce4hqh.mp3', trackNumber: 13, duration: 170 } // 2:50
    ]
  },
  ...
  // Shayda - "FOUR" album
  {
    ...
    tracks: [
      { title: 'Get Closer', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870808/Get_Closer_lwokor.mp3', trackNumber: 1, duration: 158 }, // 2:38
      { title: 'Deep', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870801/Deep_ph5ixw.mp3', trackNumber: 2, duration: 189 }, // 3:09
      { title: 'Fight', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870813/Fight_zkw7kt.mp3', trackNumber: 3, duration: 162 }, // 2:42
      { title: 'Myself', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870828/Myself_zvrbxh.mp3', trackNumber: 4, duration: 170 }, // 2:50
      { title: 'Heaven-Sent', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870816/Heaven-Sent_ldz9mh.mp3', trackNumber: 5, duration: 209 }, // 3:29
      { title: 'BADAK', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870794/BADAK_q7bnli.mp3', trackNumber: 6, duration: 147 }, // 2:27
      { title: 'Fuck Off', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870807/Fuck_Off_ph5nf7.mp3', trackNumber: 7, duration: 176 }, // 2:56
      { title: 'Kill Me', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870824/Kill_Me_kqjk3m.mp3', trackNumber: 8, duration: 192 }, // 3:12
      { title: 'Her', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870813/Her_cbenhi.mp3', trackNumber: 9, duration: 161 }, // 2:41
      { title: 'How Come ?', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870816/How_Come_so91mf.mp3', trackNumber: 10, duration: 208 }, // 3:28
      { title: 'Change', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870799/Change_w2ase4.mp3', trackNumber: 11, duration: 196 }, // 3:16
      { title: 'Face Out', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870804/Face_Out_e3v6ln.mp3', trackNumber: 12, duration: 212 }, // 3:32
      { title: 'Love Yaaa', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870828/Love_Yaaa_ntxuwl.mp3', trackNumber: 13, duration: 167 }, // 2:47
      { title: 'Tease My Lover', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870832/Tease_My_Lover_vbvipn.mp3', trackNumber: 14, duration: 198 }, // 3:18
      { title: 'Grateful To Us', audioUrl: 'https://res.cloudinary.com/dsw1dm5ka/video/upload/v1743870814/Grateful_To_Us_cpsmqd.mp3', trackNumber: 15, duration: 211 } // 3:31
    ]
  },
