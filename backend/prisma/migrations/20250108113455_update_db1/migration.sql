...
-- CreateIndex
CREATE UNIQUE INDEX "artists_email_name_key" ON "artists"("email", "name");
...
-- CreateIndex
CREATE UNIQUE INDEX "notifications_userId_artistId_type_key" ON "notifications"("userId", "artistId", "type");
