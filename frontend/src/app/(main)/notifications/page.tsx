  ...
  return (
    <div className="min-h-screen bg-black py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold mb-6 text-white">Thông báo của bạn</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {notifications.map((notification) => (
              <Link
                ...
                className="flex items-center bg-gray-900 rounded-lg shadow p-4 hover:bg-gray-800 transition"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs mt-1">
                    {notification.isRead ? (
                      ...
                      <span className="text-red-400 font-medium">Chưa đọc</span>
                    )}
                  </p>
                </div>
              </Link>
